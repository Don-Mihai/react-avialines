        ...
        <>
            <div className={styles.container}>
                <div className={styles.text}>
                    <span>
                        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quos, tenetur! Magnam voluptates aperiam cupiditate. Dolor magni molestias
                        officia aliquam impedit. Quo deleniti neque, obcaecati consectetur porro explicabo commodi quasi ipsa.
                    </span>
                </div>
                <div className={styles.content}>
                    <h3 className={styles.title}>
                        Название фото Название фото Название фото Название фото Название фото Название фото Название фото Название фото Название фото Название
                        фото Название фото Название фото Название фото Название фото Название фото Название фото Название фото Название фото Название фото
                    </h3>
