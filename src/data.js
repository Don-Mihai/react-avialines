...
export const italy = {
    ...
    videos: [
        { src: '/videos/preview.mp4', title: 'название видео1' },
        { src: '/videos/preview.mp4', title: 'название видео2' },
        { src: '/videos/preview.mp4', title: 'название видео3' },
        { src: '/videos/preview.mp4', title: 'название видео4' },
        { src: '/videos/preview.mp4', title: 'название видео5' },
        { src: '/videos/preview.mp4', title: 'название видео6' },
        { src: '/videos/preview.mp4', title: 'название видео7' },
        { src: '/videos/preview.mp4', title: 'название видео8' },
    ],
    audios: [
        { src: '/audios/preview.mp3', title: 'название аудио1' },
        { src: '/audios/preview.mp3', title: 'название аудио2' },
        { src: '/audios/preview.mp3', title: 'название аудио3' },
        { src: '/audios/preview.mp3', title: 'название аудио4' },
        { src: '/audios/preview.mp3', title: 'название аудио5' },
        { src: '/audios/preview.mp3', title: 'название аудио6' },
        { src: '/audios/preview.mp3', title: 'название аудио7' },
        { src: '/audios/preview.mp3', title: 'название аудио8' },
    ],
};
        ...
        crossword: [
            {
                ...
                questions: [
                    ...
                    },
                    {
                        ...
                        direction: 'По горизонтали:',
                        question:
                            'Использование каких самолетов позволяло приземляться на водные поверхности, что было особенно актуально в условиях сурового климата?',
                        answer: '(Гидросамолет)',
                    },
                    {
                        id: 3,
...
export const personaliiData = [
    {
        id: 1, //ПЕРСОНАЛИИ ГАЛЕРЕЯ
        persons: [
            {
                id: 1,
                ...
                name: 'В.С. Молоков',
                date: '(1895-1982)',
                image: [{ src: '../images/405556797_1112841.jpg' }],
                description: 'Советский лётчик, Герой Советского Союза, участник Великой Отечественной войны.',
            },
            {
                id: 2,
                profession: 'лётчики',
                name: 'М.В. Водопьянов',
                date: '(1899-1980)',
                image: [{ src: '../images/водопьянов.jpg' }],
                description: 'Советский лётчик, Герой Советского Союза, участник Великой Отечественной войны.',
            },
            {
                id: 3,
                ...
                name: 'Н.П. Каманин',
                date: '(1908-1982)',
                image: [{ src: '../images/Н. П. Каманин.JPG' }, { src: '../images/Н.П. Каманин и Ю.А. Гагарин.JPG' }],
                description: 'Советский лётчик, Герой Советского Союза, участник Великой Отечественной войны.',
            },
        ],
    },
    {
        ...
        biography: [
            ...
            },
            {
                ...
                discription:
                    'Cоветский лётчик, один из первых' + 'Героев Советского Союза, генерал-майор Советских ВВС. Занимался' + 'литературной деятельностью.',
                dates: [
                    {
                        date: '1918 г.',
            ...
            },
            {
                ...
                discription: 'Советский летчик, генерал-полковник авиации, один из первых семиГероев Советского Союза.',
                dates: [
                    {
                        date: '1927 г.',
        ...
        gallery: [
            {
                id: 1,
                image: [
                    { src: '../images/405556797_1112841.jpg', name: '405556797_1112841.jpg' },
...
export const historicalData = [
    {
        id: 1,
        title: 'спасение экипажа и пассажиров дирижабля «италия»',
        description:
            'Календарь: 1928 гг. Место: в 100 километрах к северу от Шпицбергена. Весной 1928 года экспедиция на дирижабле «Италия» под командованием Умберто Нобиле отправилась к Северному полюсу, цель была достигнута, но на обратином пути героический эпос о покорении Арктики обернулся трагедией. 28 мая 1928 года в 100 километрах к северу от Шпицбергена диражабль «Италия» потерпел крушение. В спасательных работах приняло участие 6 стран, более 40 судов и самолетов.',
        photo: [
            { src: '../images/Italy1.jpg', name: '«Италия» в бухте Кингсбей (остров Западный Шпицберген)' },
            { src: '../images/Italy2.jpg', name: '«Италия» перед стартом из Милана' },
